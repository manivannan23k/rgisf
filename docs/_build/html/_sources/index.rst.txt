...
1.2.4. Band.generateTiles(z1, z2, dirPath)
=========================================================================
...
1.2.6. Band.saveTileAsPng(x, y, z, filePath)
==================================================================
...
Support for client side usage with limited features which includes reading and rendering raster data. Currently, web client(browser) library is not supporting:
* Reading GeoTiff
* Accessing filesystems
* Generating tiles

    You can get the browser build from this CDN link: https://cdn.jsdelivr.net/npm/rgisf@latest/rgisf.browser.js
